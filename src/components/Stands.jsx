...
const [topic,setTopics]=useState("MERCHANDISE")
const [textbody,setTextBody]=useState("We are having a good range of Vendors who are Expert in their own field and are well known for their timely delivery of High End Quality Merchandise.")
    const changetext1=()=>{
